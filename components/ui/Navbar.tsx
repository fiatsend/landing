...
const navigation = [
	...
	{ name: 'Web Wallet (Coming Soon)', href: 'https://wallet.fiatsend.com', newWindow: true },
...
const Navbar = () => {
	...
	return (
		<header className=" inset-x-0 top-0 z-50 bg-zinc-700 text-yellow-50">
			<nav
			...
			>
				...
				<Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-zinc-700 text-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
